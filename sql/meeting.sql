...
FOREIGN KEY fk_meeting_room (roomId) 
	REFERENCES room(id));  
...
PRIMARY KEY pk_meeting_employee (meetingId, employeeId),
CONSTRAINT fk_meeting_employee_meeting 
FOREIGN KEY fk_meeting_employee_meeting (meetingId) 
REFERENCES meeting (id),
CONSTRAINT fk_meeting_employee_employee 
FOREIGN KEY fk_meeting_employee_employee (employeeId) 
